# Generated by Django 6.0.1 on 2026-01-07 15:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_type', models.CharField(choices=[('tutorial', 'Tutorial'), ('article', 'Article'), ('lesson', 'Course Lesson')], default='tutorial', max_length=20)),
                ...
                ('course', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='posts', to='blog.course')),
